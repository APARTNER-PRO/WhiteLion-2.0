    ...
    <div id="app" class="app">
        <div class="login login-v2 fw-bold">
            ...
            <div class="login-cover">
                <div class="login-cover-img" style="background-image: url(<?= ASSETS_PATH ?>images/login-bg-3.jpg)" data-id="login-cover-image"></div>
            ...
            <div class="login-container">
                ...
                <div class="login-header">
                    <div class="brand">
                        <div class="d-flex align-items-center">
                            <span class="logo"></span> <b class="me-5px">Reset</b> password
                        </div>
                ...
                <div class="login-content">
                    ...
                    <form action="<?= SITE_URL ?>reset" method="POST" id="resetForm">
                        ...
                        <div class="mb-20px">
                            <?php $this->recaptcha->button('Sign me in <i class="fas fa-sign-in-alt"></i>', 'resetForm', "btn btn-success d-block w-100 h-45px btn-lg") ?>
                        </div>

                        <div class="text-gray-500">
                            Back to <a href="<?= SITE_URL ?>" class="text-white">Main page</a> or <a href="<?= SITE_URL ?>login" class="text-white">login</a>.
                        </div>
                    </form>
                </div>
                <!-- END login-content -->
        ...
        <div class="login-bg-list clearfix">
            <div class="login-bg-list-item active"><a href="javascript:;" class="login-bg-list-link" data-toggle="login-change-bg" data-img="<?= ASSETS_PATH ?>images/login-bg-3.jpg" style="background-image: url(<?= ASSETS_PATH ?>images/login-bg-3.jpg)"></a></div>
