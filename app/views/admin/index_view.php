<?php require_once '@commons/widgets.php';
...
if(!empty($__dashboard_subview))
{
    ...
    foreach ($__dashboard_subview as $key => $subview) {
        ...
        else if($key >= 10 && $key < 20)
        {
            ...
            echo '<div class="col-md-6 ui-sortable">'.
                    $subview .
                '</div>';
        }
    }
...
<div class="row">
    <div class="col-md-8 ui-sortable">
    	<?php require_once '@commons/wl_statistic.php'; ?>
    </div>
    <?php if(!empty($__dashboard_subview))
    {
        foreach ($__dashboard_subview as $key => $subview) {
            if($key >= 20) {
                echo '<div class="col-md-4 ui-sortable">'.
                        $subview .
                    '</div>';
            }
        }
    ...
    <div class="col-md-4 ui-sortable">
		<?php require_once '@commons/wl_users.php'; ?>
    </div>
</div>