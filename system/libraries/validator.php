...
class validator {
    ...
    public function phone($field, $data = '')
    {
        ...
        {
            array_push($this->errors, $field.': wrong phone format.');
            return false;
        }
        return true;
    }

    // TODO: can be adjusted to support strict comparison if needed
     ...
     * @return <string>
     */
    public function getErrors($open_tag = '', $closed_tag = '. ')
    {
        $errors = '';
